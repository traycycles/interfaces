...
<div class="navbar-wrapper">
    <div class="container">
        ...
        <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
            ...
            <a class="navbar-brand" href="index.php">Group News & Events</a>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    foreach(new Pages($repo) as $page){
                        ...
                        //set active item (see if slug is set)...
                ...
                <ul class="navbar-nav mt-2 mt-md-0">
                    <li class="nav-item
                    <?php//checking to see if blog is active
...
<?php if($content instanceof Pages){  //will check for any class or interface in hierarchy?>
<!-- Begin page Image -->
